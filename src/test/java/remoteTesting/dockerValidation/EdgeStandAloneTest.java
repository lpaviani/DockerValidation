...
public class EdgeStandAloneTest {
	...
	public static void main(String[] args) throws MalformedURLException {
        ...
        //Initializing Edge on RemoteWebDriver targeting the Docker Container
        driver = new RemoteWebDriver(new URL(host_url),edge_options);
		driver.get(app_url);	
